...
class carp extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Block center bottom flex={0.8}><Image style= {styles.image} source={require('../assets/carpoool.jpg')} /></Block>
        ...
        <Block bottom flex={0.3} margin={[50, theme.sizes.padding * 2]}>
          <Button gradient onPress={() => navigation.navigate("DriverRide")}>
            <Text center semibold white>
              Driver
            </Text>
          </Button>
          <Button gradient onPress={() => navigation.navigate("Carpooling")}>
            <Text center semibold white>
              Rider
            </Text>
          </Button>
